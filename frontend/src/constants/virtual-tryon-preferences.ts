...
export const VTO_PREFERENCES_BY_STYLE: Record<VtoStyleKey, VtoPrefGroup> = {
  ...
  classical: {
    makeup: [
      ...
      { value: 'gf_blush', label: '微醺腮红（淡扫晕染）' },
  ...
  romantic: {
    makeup: [
      { value: 'sx_morandi', label: '莫兰迪胶片妆（低饱和颗粒感）' },
      { value: 'sx_dew', label: '露水清透肌底妆' },
      { value: 'sx_pearl', label: '珍珠光泽+柔和腮红（轻扫、忌过重）' },
      { value: 'sx_rosy', label: '豆沙玫瑰唇' },
      { value: 'sx_earth', label: '大地杏色眼妆' },
      { value: 'sx_glitter', label: '细闪卧蚕提亮' },
      { value: 'sx_fresh', label: '果汁感清透唇釉' },
    ],
    hairstyle: [
      { value: 'sx_veil_long', label: '大蕾丝花边长款头纱+披发' },
      { value: 'sx_veil_low', label: '低盘髻+蕾丝头纱' },
      { value: 'sx_veil_half', label: '半扎鲜花+飘逸头纱' },
      { value: 'sx_loose', label: '森系自然披发' },
      { value: 'sx_curtain', label: '空气刘海卷+头纱' },
      { value: 'sx_low', label: '慵懒低马尾+头纱' },
      { value: 'sx_mermaid_veil', label: '鱼尾造型配荷叶边超长头纱' },
    ],
    dress: [
      { value: 'sx_strapless_veil', label: '白色抹胸婚纱+大蕾丝花边头纱' },
      { value: 'sx_mermaid_lace', label: '蕾丝鱼尾长袖+荷叶边头纱' },
      { value: 'sx_lawn', label: '草坪轻拖尾抹胸纱' },
      { value: 'sx_ball', label: '公主蓬蓬抹胸纱' },
      { value: 'sx_off', label: '一字肩蕾丝婚纱' },
      { value: 'sx_flower', label: '立体花朵抹胸纱' },
      { value: 'sx_short', label: '短款森系轻纱' },
    ],
  },
  adventure: {
    makeup: [
      { value: 'ky_golden', label: '日出暖金精致新娘妆' },
      { value: 'ky_refined', label: '清透精致上镜妆' },
      { value: 'ky_matte', label: '哑光立体轮廓' },
      { value: 'ky_warm', label: '暖调高光修容（逆光友好）' },
      { value: 'ky_sunset', label: '日落渐变眼影' },
      { value: 'ky_nude', label: '高级裸色唇妆' },
      { value: 'ky_snow_cool', label: '冰感冷调妆（雪山/清晨备选）' },
      { value: 'ky_smoky', label: '轻烟熏（个性备选）' },
    ],
    hairstyle: [
      { value: 'ky_wave', label: '波浪卷发（主推）' },
      { value: 'ky_loose', label: '大卷披肩' },
      { value: 'ky_half', label: '半扎波浪卷' },
      { value: 'ky_wind', label: '风吹动感卷发' },
      { value: 'ky_pony', label: '高马尾' },
      { value: 'ky_braid', label: '侧编发/拳击辫' },
      { value: 'ky_hat', label: '牛仔帽造型' },
    ],
    dress: [
      { value: 'ky_lace_ball_veil', label: '无肩带白色蕾丝蓬蓬婚纱+刺绣长头纱' },
      { value: 'ky_trail', label: '蕾丝长拖尾+头纱（山野公路）' },
      { value: 'ky_slit', label: '高开衩轻纱' },
      { value: 'ky_leather', label: '婚纱+皮衣混搭' },
      { value: 'ky_cape', label: '长斗篷蕾丝纱' },
      { value: 'ky_light', label: '轻量便携婚纱' },
...
export const VTO_PREFERENCES_MALE_BY_STYLE: Record<VtoStyleKey, VtoPrefGroup> = {
  ...
  romantic: {
    makeup: [
      { value: 'mg_sx_film', label: '胶片感自然修容（男）' },
      { value: 'mg_sx_fresh', label: '清新氧气底妆（男）' },
      { value: 'mg_sx_soft', label: '柔雾眉+豆沙唇（男）' },
      { value: 'mg_sx_blush', label: '微醺腮红（男，宜淡扫）' },
      { value: 'mg_sx_dew', label: '露水肌（男）' },
      { value: 'mg_sx_even', label: '匀亮肤色' },
      { value: 'mg_sx_natural', label: '伪素颜修容' },
    ],
    hairstyle: [
      { value: 'mg_sx_side', label: '微风侧分油头' },
      { value: 'mg_sx_slick', label: '服帖背梳' },
      { value: 'mg_sx_curl', label: '自然纹理卷发（男）' },
      { value: 'mg_sx_half', label: '半扎发（男）' },
      { value: 'mg_sx_flower', label: '胸花固定（草坪婚礼）' },
      { value: 'mg_sx_loose_long', label: '披肩中长发' },
      { value: 'mg_sx_braid', label: '侧辫点缀' },
    ],
    dress: [
      { value: 'mg_sx_tux_bow', label: '黑色西装白衬衫黑领结（塔士多）' },
      { value: 'mg_sx_black3', label: '黑色三件套西装' },
      ...
      { value: 'mg_sx_layer', label: '马甲叠穿+领结' },
    ],
  },
  adventure: {
    makeup: [
      { value: 'mg_ky_golden', label: '日出暖光修容（男）' },
      { value: 'mg_ky_matte', label: '哑光立体底妆（男）' },
      { value: 'mg_ky_contour', label: '轻轮廓修容（男）' },
      { value: 'mg_ky_brow', label: '浓眉定型' },
      { value: 'mg_ky_smoky', label: '轻烟熏（男）' },
      { value: 'mg_ky_nude', label: '裸色唇（男）' },
      { value: 'mg_ky_fresh', label: '清爽控油肤质' },
    ],
    hairstyle: [
      { value: 'mg_ky_keep_ref', label: '自然纹理短发（可贴近原图）' },
      { value: 'mg_ky_side', label: '侧分纹理' },
      { value: 'mg_ky_slick', label: '服帖背梳' },
      { value: 'mg_ky_wind', label: '风吹凌乱纹理' },
      { value: 'mg_ky_hat', label: '牛仔/渔夫帽' },
      { value: 'mg_ky_short', label: '利落短寸' },
      { value: 'mg_ky_pomade', label: '油头定型' },
    ],
    dress: [
      { value: 'mg_ky_bespoke', label: '黑色定制西装白衬衫黑领结' },
      { value: 'mg_ky_black3', label: '黑色三件套西装' },
      { value: 'mg_ky_slim', label: '修身黑色戗驳领西装' },
      { value: 'mg_ky_long_coat', label: '长大衣叠穿西装' },
      { value: 'mg_ky_leather', label: '皮衣+西裤' },
      { value: 'mg_ky_vest', label: '马甲三件套+领结' },
      { value: 'mg_ky_layer', label: '高领毛衣+西装外套' },
    ],
  },
  artistic: {
    makeup: [
...
export const VTO_PREFERENCES_COUPLE_BY_STYLE: Record<VtoStyleKey, VtoPrefGroup> = {
  ...
  bohemian: {
    makeup: [
      ...
      { value: 'cp_hd_bronze', label: '新娘晒伤腮红（轻淡）+新郎古铜' },
  ...
  romantic: {
    makeup: [
      { value: 'cp_sx_morandi', label: '莫兰迪胶片感双人均衡' },
      { value: 'cp_sx_dew', label: '露水肌双人均衡' },
      { value: 'cp_sx_rosy', label: '玫瑰豆沙双人均衡' },
      { value: 'cp_sx_skin', label: '纪实真实肤质双人均衡' },
      { value: 'cp_sx_glitter', label: '细闪卧蚕双人均衡' },
      { value: 'cp_sx_coral', label: '珊瑚橘腮红（淡扫，女）+修容（男）' },
      { value: 'cp_sx_fresh', label: '果汁感清透双人均衡' },
    ],
    hairstyle: [
      { value: 'cp_sx_veil_bow', label: '新娘大头纱+新郎侧分油头' },
      { value: 'cp_sx_half', label: '新娘半扎头纱+男背梳' },
      { value: 'cp_sx_loose', label: '新娘披发头纱+男自然纹理' },
      { value: 'cp_sx_curtain', label: '新娘空气刘海+男服帖造型' },
      { value: 'cp_sx_low', label: '新娘低马尾头纱+男短发' },
      { value: 'cp_sx_mermaid', label: '新娘荷叶边头纱鱼尾款+男塔士多' },
      { value: 'cp_sx_fun', label: '趣味互动款（头纱飞扬+男清爽）' },
    ],
    dress: [
      { value: 'cp_sx_strap_bow', label: '新娘抹胸蕾丝头纱+新郎黑西装领结' },
      { value: 'cp_sx_mermaid_bow', label: '新娘鱼尾蕾丝长袖+新郎黑西装' },
      { value: 'cp_sx_lawn', label: '草坪拖尾抹胸+轻便黑西装' },
      { value: 'cp_sx_ball', label: '公主蓬蓬抹胸+塔士多' },
      { value: 'cp_sx_off', label: '一字肩蕾丝+领结西装' },
      { value: 'cp_sx_flower', label: '立体花抹胸+口袋巾西装' },
      { value: 'cp_sx_short', label: '短款森系纱+短西装' },
    ],
  },
  adventure: {
    makeup: [
      { value: 'cp_ky_golden', label: '日出暖金双人均衡（女精致+男清爽）' },
      { value: 'cp_ky_refined', label: '新娘清透上镜+新郎哑光修容' },
      { value: 'cp_ky_matte', label: '哑光立体双人均衡' },
      { value: 'cp_ky_warm', label: '暖调高光双人均衡（逆光）' },
      { value: 'cp_ky_sunset', label: '日落眼影双人均衡' },
      { value: 'cp_ky_nude', label: '裸色唇妆双人均衡' },
      { value: 'cp_ky_cool', label: '冷调备选（雪山清晨感）' },
    ],
    hairstyle: [
      { value: 'cp_ky_wave_ref', label: '新娘波浪卷+新郎自然纹理（可贴近原图）' },
      { value: 'cp_ky_loose', label: '新娘大卷披肩+男侧分' },
      { value: 'cp_ky_half', label: '新娘半扎卷+男背梳' },
      { value: 'cp_ky_wind', label: '风吹动感双人均衡' },
      { value: 'cp_ky_hat', label: '牛仔帽（女或男）造型' },
      { value: 'cp_ky_pony', label: '新娘高马尾+男短发' },
      { value: 'cp_ky_braid', label: '新娘侧编+男纹理' },
    ],
    dress: [
      { value: 'cp_ky_lace_bow', label: '蕾丝蓬蓬婚纱+刺绣头纱+黑西装领结' },
      { value: 'cp_ky_trail_bow', label: '蕾丝长拖尾+头纱+黑色三件套' },
      { value: 'cp_ky_slit', label: '高开衩轻纱+修身黑西装' },
      { value: 'cp_ky_leather', label: '婚纱+皮衣混搭与男皮衣西装' },
      { value: 'cp_ky_cape', label: '长斗篷纱+长大衣西装' },
      { value: 'cp_ky_light', label: '轻量婚纱+便携西装' },
